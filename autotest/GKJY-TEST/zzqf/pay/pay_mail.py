...
def sendMail(taddr="lihl@casjc.com",url="http://10.9.19.179"):
    msg = MIMEMultipart()
    ...
    body = """<html><body><h1>测试结果</h1><p><img src='cid:imageid' /></p><a href='""" + url + """' target='_blank'>查看结果</a></body></html>"""
